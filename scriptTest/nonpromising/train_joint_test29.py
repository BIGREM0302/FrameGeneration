...
FUSION_MODEL_BEST_PATH = "joint_fusion_net_best29.pth"
REFINE_MODEL_BEST_PATH = "flow_refine_net_best29.pth"
PRECOMPUTED_DIR = "./lightweight_precomputed_flow_pt"
LOSS_PLOT_PATH = "loss_curve29.png"
...
# =========================================================================
# 1. RefineNet: 無痛升級 64 通道 (因在 1/16 像素量執行，算力增加極微)
# =========================================================================
...
# =========================================================================
# 2. FusionNet: 黃金比例 56/28/84/40 (完美貼齊 ~180k MACs 預算)
# =========================================================================
        ...
        for task in train_tasks:
            ...
            for t in pbar:
                ...
                with torch.amp.autocast('cuda'):
                    ...
                    # 🌟 訓練關鍵優化：Warp Loss 改為對齊 b_gt，且使用 Charbonnier，指引網路尋求真正的高清對齊
