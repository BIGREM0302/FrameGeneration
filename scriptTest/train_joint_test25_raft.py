...
FUSION_MODEL_PATH = "joint_fusion_net_v25_raft.pth"
REFINE_MODEL_PATH = "flow_refine_net_v25_raft.pth"
FUSION_MODEL_BEST_PATH = "joint_fusion_net_v25_raft_best.pth"
REFINE_MODEL_BEST_PATH = "flow_refine_net_v25_raft_best.pth"
PRECOMPUTED_DIR = "./lightweight_precomputed_flow_raft"
LOSS_PLOT_PATH = "loss_curve_v25_raft.png"
...
# =========================================================================
# 1. 架構優化版 Lite-V25 (完美控制在 ~65k MACs/pixel)
# =========================================================================
class LiteFlowRefineNet(nn.Module):
    # RAFT 已經很準，RefineNet 降至 32 通道即可
    def __init__(self):
...
class LiteMicroFusionNetV25(nn.Module):
    ...
    def forward(self, t_up, warped_p, warped_n, flow_consistency, laplacian_guide, epi_p, epi_n):
        ...
        raw_logits = out[:, :3, :, :]
        # Tanh 範圍微調，因 RAFT 對齊極準，殘差修補不需太大
